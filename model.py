...
def generate_model_mbt(model_type="mbt", model_scale="base", model_size=224, patch_size=16,
                       no_cuda=False, gpu_id=[0], is_multi=False, pretrain_path=None, nb_class=2, drop_out=0.0,
                       phase_num=8, bottleneck_n=8, backbone="vit", in_channel=1):
...
if __name__ == "__main__":
    img = torch.Tensor(16, 8, 3, 224, 224)
    global_net = generate_model_mbt()
    gamma = global_net(img.cuda())