...
ROOT_DATASET = 'D:/code/datav1/'


def return_301data(modality):
    filename_categories = 'labels/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = 'file_list/eight/{}_for_train.txt'
        filename_imglist_val = 'file_list/eight/{}_for_val.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, '301data':return_301data }
